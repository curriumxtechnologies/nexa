              ...
              <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center justify-between bg-white border border-gray-200 rounded-lg p-2">
                    <code className="text-xs text-gray-600 truncate">
                      {`${window.location.origin}/api/email/webhook/receive`}
                    </code>
                    <button
                      onClick={() => copyWebhookUrl(`${window.location.origin}/api/email/webhook/receive`)}
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Create a new webhook, paste the URL above, and get your signing secret
                  </p>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Step 3: Enter Webhook Signing Secret
                  </label>
                  <div className="relative">
                    <Key className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                    <input
                  ...
                  {webhookError && (
                    <p className="text-xs text-red-500 mt-1">{webhookError}</p>
                  )}
                </div>
