...
import { Eye, EyeOff, Mail, Lock, Shield, X } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-purple-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url("/email-background.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16 xl:px-20 text-white">
          <div className="mb-8">
            <img src="/nexa-logo.png" alt="Nexa Logo" className="h-12 w-auto brightness-0 invert" />
          </div>
          ...
          <p className="text-lg lg:text-xl text-white/90 mb-8 leading-relaxed">
            ...
            Built for developers and companies who need reliable email delivery at scale.
          </p>

          <div className="space-y-4">
            {['Custom domain email sending', 'Resend API integration', '2-Step verification for security'].map((feature) => (
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-sm text-white/70">Trusted by developers and companies worldwide</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-purple-800">
                {forgotStep === 'email' ? 'Reset Password' : 'Enter OTP & New Password'}
              </h3>
            ...
            {forgotStep === 'email' ? (
              <form onSubmit={handleForgotSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2.5 px-4 rounded-lg transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
                >
                  {isForgotLoading ? (
                    <span className="flex items-center justify-center">
                      <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              ...
              <form onSubmit={handleResetSubmit} className="space-y-4">
                <div>
                  <label htmlFor="reset-otp" className="block text-sm font-semibold text-gray-700 mb-2">
                    OTP Code
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
